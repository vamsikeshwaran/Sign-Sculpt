...
cred = credentials.Certificate(
    "/Users/vamsikeshwaran/MyChatbot/serviceAccount.json")
...
def load_model_and_actions():
    global model
    model = load_model('/Users/vamsikeshwaran/action.h5')
...
def chat():
    ...
    cap = cv2.VideoCapture("/Users/vamsikeshwaran/MyChatbot/sample_video.mp4")
    ...
    if video_text:
        assets_folder = '/Users/vamsikeshwaran/Desktop/DataSet'  # Adjust path as needed
